...
class RootBuilder(dependency: ParentComponent) :
    ...
    abstract class Module {
        ...
        companion object {
            ...
            internal fun router(
                ...
                return RootRouter(view, interactor, component, HolderBuilder(component))
            }
        }
    ...
    interface Component : InteractorBaseComponent<RootInteractor>, HolderBuilder.ParentComponent, BuilderComponent {
